...
ADD PRIMARY KEY("zakwaterowanie_id");
...
ALTER TABLE "Pokoj"
ADD CONSTRAINT "pokoj_kategoria_id_foreign" FOREIGN KEY("kategoria_id") REFERENCES "Kategoria"("kategoria_id");
ALTER TABLE "Rezerwacja"
ADD CONSTRAINT "rezerwacja_pokoj_id_foreign" FOREIGN KEY("pokoj_id") REFERENCES "Pokoj"("pokoj_id");
ALTER TABLE "Rezerwacja"
ADD CONSTRAINT "rezerwacja_uzytkownik_id_foreign" FOREIGN KEY("uzytkownik_id") REFERENCES "Uzytkownik"("uzytkownik_id");
ALTER TABLE "Platnosc"
ADD CONSTRAINT "platnosc_rezerwacja_id_foreign" FOREIGN KEY("rezerwacja_id") REFERENCES "Rezerwacja"("rezerwacja_id");
ALTER TABLE "Zakwaterowanie"
ADD CONSTRAINT "zakwaterowanie_rezerwacja_id_foreign" FOREIGN KEY("rezerwacja_id") REFERENCES "Rezerwacja"("rezerwacja_id");
ALTER TABLE "Pracownicy_pokoju"
ADD CONSTRAINT "pracownicy_pokoju_pracownik_id_foreign" FOREIGN KEY("pracownik_id") REFERENCES "Pracownik"("pracownik_id");
ALTER TABLE "Pracownicy_pokoju"
ADD CONSTRAINT "pracownicy_pokoju_pokoj_id_foreign" FOREIGN KEY("pokoj_id") REFERENCES "Pokoj"("pokoj_id");